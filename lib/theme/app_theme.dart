...
class AppTheme {
  ...
  // Serene Earth Palette - Wellness color system
  static const Color primaryLight = Color(0xFF8B4513); // Warm earth brown
  static const Color primaryVariantLight =
      Color(0xFF6B3410); // Darker earth brown
  static const Color secondaryLight = Color(0xFFCD853F); // Sandy brown
  static const Color secondaryVariantLight =
      Color(0xFFB8732E); // Darker sandy brown
  static const Color accentLight = Color(0xFFFF6B35); // Mindful orange
  static const Color backgroundLight = Color(0xFFFFF8F0); // Warm off-white
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color errorLight = Color(0xFFA0522D); // Muted sienna
  static const Color successLight = Color(0xFF4A7C59); // Natural green
